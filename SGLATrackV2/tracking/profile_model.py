...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='sglatrackv2', choices=['sglatrackv2'],
...
def evaluate_sglatrackv2(model, template, search):
    '''Speed Test'''
...
if __name__ == "__main__":
    ...
    if args.script == "sglatrackv2":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_sglatrackv2
        ...
        evaluate_sglatrackv2(model, template, search)
